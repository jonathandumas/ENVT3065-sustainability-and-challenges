...
| To be defined |<br>Lecture 5: part 1 (presentation) [Fossil energies, issues for the society & economy]()<br>Lecture 5: part 2 (activity) analyze the report [Possible déclin de l’approvisionnement en pétrole de l’UE d’ici 2030](https://theshiftproject.org/article/ue-declin-approvisionnements-petrole-2030-etude/)<br>Lecture 5: part 3 (activity) present the report|
